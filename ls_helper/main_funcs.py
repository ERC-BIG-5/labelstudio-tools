...
from ls_helper.new_models import platforms_overview, ProjectAnnotationResultsModel, ProjectData
from ls_helper.project_mgmt import ProjectMgmt
from main import open_image_simple


def status(project: ProjectData, accepted_ann_age: int = 6):
    _, project_annotations= ProjectMgmt.get_recent_annotations(project.id, accepted_ann_age)
